...
const Help = () => {
  const faqs = [
    ...
    { q: 'How do I contact support?', a: 'Visit our Contact page or email support@bluehavengrand.com' },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-blue-900 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        >
          ...
          <p className="text-gray-300 mt-2">How can we help you today?</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-blue-900/40 rounded-2xl p-6 text-center border border-amber-500/20">
            ...
            <p className="text-amber-400 mt-2">support@bluehavengrand.com</p>
          </div>
          <div className="bg-blue-900/40 rounded-2xl p-6 text-center border border-amber-500/20">
            <div className="text-4xl mb-3">💬</div>
        ...
        <div className="bg-blue-900/40 rounded-2xl p-6 border border-amber-500/20">
          <h2 className="text-xl font-bold text-white mb-6">Frequently Asked Questions</h2>
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div key={index} className="border-b border-cyan-800 pb-4 last:border-0">
