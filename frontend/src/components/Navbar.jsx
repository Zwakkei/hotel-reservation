...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-blue-900 via-cyan-900 to-blue-900 text-white shadow-lg sticky top-0 z-50">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            <Link to="/amenities" className="hover:text-amber-400 transition">Amenities</Link>
            ...
            {isAuthenticated ? (
              <>
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  {isDropdownOpen && (
                    <div className="absolute right-0 mt-2 w-64 bg-blue-900/95 backdrop-blur-sm rounded-xl shadow-2xl border border-amber-500/20 overflow-hidden z-50">
                      {/* User Info Header */}
                      <div className="px-4 py-3 border-b border-cyan-800 bg-blue-900/50">
                      ...
                      <div className="py-2">
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-4 py-3 text-gray-200 hover:bg-amber-600/20 hover:text-amber-400 transition-all duration-200"
                        >
                        ...
                        <div className="border-t border-cyan-800 my-1"></div>
